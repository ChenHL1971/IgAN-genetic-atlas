## ---- Supplemental Tables S1-S7 (one Excel workbook) — needs proj_dir, atl_dir ----
...
addWorksheet(wb, "README"); writeData(wb, "README", "Supplemental Tables for: An Ancestry-Resolved Cell-Type and Molecular Map of Genetic Risk for IgA Nephropathy", startRow = 1)
...
out <- file.path(sub_dir, "Supplemental_Tables_S1-S7.xlsx"); saveWorkbook(wb, out, overwrite = TRUE)
